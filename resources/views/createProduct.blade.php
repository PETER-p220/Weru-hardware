...
<head>
    ...
    <title>Add New Product - Weru Hardware</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center gap-6">
                    <a href="{{ route('createProduct') }}" class="text-sm font-semibold text-blue-600">Products</a>
                    <a href="{{route('createCategory')}}" class="text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors">Categories</a>
                </nav>
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 text-sm text-gray-600 mb-3">
                <a href="{{ route('createProduct') }}" class="hover:text-blue-600">Products</a>
                <span>/</span>
                <span class="text-gray-900">Add New</span>
            </div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Add New Product</h1>
            <p class="text-gray-600">Fill in the details below to add a new product to the catalog</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="slug" name="slug" value="{{ old('slug') }}" required 
                            ...
                            placeholder="e.g., mbeya-opc-cement-50kg-bag">
                        <p class="text-xs text-gray-500 mt-1">URL-friendly version of product name (auto-generated from name)</p>
                        @error('slug')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="old_price" name="old_price" value="{{ old('old_price') }}" min="0" step="0.01"
                    ...
                    <div id="discountDisplay" class="hidden">
                        ...
                        <div class="w-full px-4 py-3 bg-green-50 border border-green-200 rounded-lg">
                            <span class="text-green-700 font-bold text-lg" id="discountPercent">0%</span>
