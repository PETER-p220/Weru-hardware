...
<head>
    ...
    <style>
        ...
        .category-card:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(212, 175, 55, 0.2); }
    </style>
</head>
<body class="bg-gray-50 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-4">
                    <a href="/login" class="hidden lg:block text-white font-semibold bg-amber-600 px-4 py-2 rounded-lg transition">Sign In</a>
                    <a href="/cart" class="relative bg-slate-800 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg hover:shadow-xl transition transform hover:scale-105">
                        <i class="fa-solid fa-cart-shopping w-5 h-5"></i>
                        Cart <span class="absolute -top-2 -right-2 bg-amber-400 text-black text-xs font-extrabold rounded-full h-6 w-6 flex items-center justify-center ring-2 ring-white">0</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <section class="hero-bg min-h-[90vh] flex items-center justify-center text-white relative py-20">
        <div class="max-w-7xl mx-auto px-6 text-center relative z-10">
            ...
            <p class="text-xl md:text-2xl text-white mb-12 max-w-4xl mx-auto font-light animate-fade-in animation-delay-400">
    ...
    <section class="py-20 bg-white relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-5xl font-extrabold text-gray-900 mb-4">Current <span class="text-amber-600">Promotions</span></h2>
                <span class="inline-block px-6 py-2 bg-amber-600 text-white rounded-full font-bold text-sm tracking-wider shadow-lg">DON'T MISS OUT ON GREAT DEALS!</span>
            </div>
    ...
    <section class="py-20 bg-gradient-to-br from-gray-50 to-gray-100" id="contact">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">Get In <span class="text-amber-600">Touch</span></h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                <div>
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-amber-600 transition" aria-label="Facebook">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="#" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-amber-600 transition" aria-label="Instagram">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a href="#" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-amber-600 transition" aria-label="Twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="#" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-amber-600 transition" aria-label="LinkedIn">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="/products" class="text-gray-400 hover:text-amber-500 transition flex items-center gap-2"><i class="fa-solid fa-chevron-right text-xs"></i> Cement & Concrete</a></li>
                        <li><a href="/products" class="text-gray-400 hover:text-amber-500 transition flex items-center gap-2"><i class="fa-solid fa-chevron-right text-xs"></i> Steel & Iron</a></li>
                        <li><a href="/products" class="text-gray-400 hover:text-amber-500 transition flex items-center gap-2"><i class="fa-solid fa-chevron-right text-xs"></i> Paints & Coatings</a></li>
                        <li><a href="/products" class="text-gray-400 hover:text-amber-500 transition flex items-center gap-2"><i class="fa-solid fa-chevron-right text-xs"></i> Roofing Materials</a></li>
                        <li><a href="/products" class="text-gray-400 hover:text-amber-500 transition flex items-center gap-2"><i class="fa-solid fa-chevron-right text-xs"></i> Plumbing Supplies</a></li>
